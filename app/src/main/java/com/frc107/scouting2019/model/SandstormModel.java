...
public class SandstormModel extends ScoutModel {
    ...
    public Question[] getQuestions() {
        NumberQuestion matchNumQuestion = new NumberQuestion("sandstormMatchNumber", R.id.matchNumberEditText, true, 0);
        NumberQuestion teamNumQuestion = new NumberQuestion("sandstormTeamNumber", R.id.teamNumberEditText, true, 1);
        ...
        Question[] questions = {
                matchNumQuestion,
                teamNumQuestion,
                new RadioQuestion("sandstormStartPos", R.id.sandstormStartingPositionRadioQuestion, true, 2,
                        new RadioQuestion.Option(R.id.habTwoSandstorm_Radiobtn, 1),
                        new RadioQuestion.Option(R.id.habOneSandstorm_Radiobtn, 0)),
                new RadioQuestion("sandstormStartPiece", R.id.sandstormStartingGamePieceRadioQuestion, true, 3,
                ...
                new RadioQuestion("sandstormItemPlaced", R.id.sandstormItemPlacedRadioQuestion, true, 4,
                ...
                new ToggleQuestion("sandstormBaseline", R.id.sandstormBaseline_chkbx, 5)
        };
        return questions;
    }
